...
import { updateTask } from "../Services/Operations/taskOperation";


function UpdateTask({ task, setShowUpdateTask, showUpdateTask }) {
  ...
  const handleUpdateTask = (data) => {
   // onUpdateTask({ ...data, id: task.id }); // Pass the updated data with task ID
   data.id=task.id;
   console.log("Updated Data :",data)

   updateTask(data,token,dispatch,change);
    ...
    <div className="modal-background">
      <div className="modal-container">
        ...
        <div className="modal-header">
          <p className="modal-title">Update Task</p>
        ...
        {/* Modal Form */}
        <form onSubmit={handleSubmit(handleUpdateTask)} className="form-container">
          {/* Task Title */}
